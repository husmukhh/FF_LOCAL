...
public interface EducationSystemConstants {
	...
	String GLOB_DIPLOMA = "GLOB_DIPLOMA";
	String GLOB_GPA = "GLOB_GPA";
	String IND_HSC_ISC_SSC = "IND_HSC_ISC_SSC";
	String US_GPA = "US_GPA";
	String NEP_HSC = "NEP_HSC";
	String PAK_HSC = "PAK_HSC";
	String KSA_DM_HSC = "KSA_DM_HSC";
	...
	String GLOB_IF = "GLOB_IF";
	String GLOB_A_LEV_ = "GLOB_A_LEV_";
	String GLOB_A_LEV_1 = "GLOB_A_LEV_1";
	String GLOB_A_LEV_2 = "GLOB_A_LEV_2";
	...
	String UK_A_LEV_  = "UK_A_LEV_";
	
	
	
	
	String IELTS_Overall_Score = "IELTS_Overall_Score";
	String IELTS_Reading = "IELTS_Reading"; 
	String IELTS_Writing = "IELTS_Writing";
	String IELTS_Listening = "IELTS_Listening";
	String IELTS_Speaking = "IELTS_Speaking";


	String TOFEL_Overall_Score = "TOFEL_Overall_Score";
	String TOFEL_Reading = "TOFEL_Reading";
	String TOFEL_Writing = "TOFEL_Writing";
	String TOFEL_Listening = "TOFEL_Listening";
	String TOFEL_Speaking = "TOFEL_Speaking";
	String READ = "read";
	String WRITE = "write";
	String LISTEN = "listen";
	String SPEAK = "speak";
	String OVERALL = "overall";
	int NO_OF_RECORD_PER_PAGE = 10;
